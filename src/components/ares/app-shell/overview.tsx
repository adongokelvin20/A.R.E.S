      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center">
            <code className="min-w-0 flex-1 truncate rounded-lg border border-ares-line bg-ares-mist/50 px-3 py-2 text-[11px] text-ares-navy">
              {storeUrl}
            </code>
            <div className="flex shrink-0 gap-2">
              <button
                onClick={copyLink}
                className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-ares-navy px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-ares-sea-deep sm:flex-none"
              >
              ...
              <a
                ...
                className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-ares-line bg-white px-3 py-2 text-xs font-semibold text-ares-navy hover:bg-ares-mist sm:flex-none"
              >
